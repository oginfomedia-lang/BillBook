            ...
            <div ref={printRef} className="receipt">
              ...
              <div className="header-sec">
                <div className="logo-wrap">
                  {/* Styled Folder-like icon matching screenshot */}
                  ...
                  <div>
                    <h3 className="brand-name">BillBook</h3>
                    <p className="brand-sub">Business made simple</p>
                  </div>
                </div>
              ...
              <div className="footer-card">
                <div className="footer-left">
                  ...
                  <div>
                    ...
                    <p className="footer-sub">Generated by BillBook</p>
                  </div>
                </div>
                <div className="sign-wrap">
                  <div className="sign-img">Demo Admin</div>
