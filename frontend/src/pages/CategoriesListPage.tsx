...
import { useCategories, useCreateCategory, useUpdateCategory, useDeleteCategory } from '../hooks/useItems';
...
export function CategoriesListPage() {
    ...
    const handleOpenEdit = (cat: any) => {
        setModal({ open: true, isEdit: true, id: cat.id, name: cat.name, desc: cat.description || '', status: cat.status || 'active' });
    };
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="e.g. Service, Electronics"
                                />
                            </div>
                            <div>
                                <label className="block text-xs font-bold text-slate-600 uppercase tracking-wider mb-1">
